...
namespace ActivityManagement.Activities.Dto
{
    ...
    // R1: Bir günün efor özeti (kayıtlar + toplam + 8 saate göre eksik)
    public class DayEffortDto
    {
        public DateTime Date { get; set; }
        public decimal TotalHours { get; set; }
        public decimal MissingHours { get; set; }
        public System.Collections.Generic.List<ActivityLogDto> Efforts { get; set; } = new System.Collections.Generic.List<ActivityLogDto>();
    }
}
